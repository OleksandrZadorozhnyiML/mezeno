...
#' @export 
#' 
download_data <- function(question_text){
  text_pre = paste0("From the following JSON data, please return the description and created date for the object with the title", question_text,". JSON-data:")
  ...
  q_set = tribble(
                            ~role, ~content,
                            "system", 'From the json-data, extract a particular piece of information that corresponds to the given title.',
                            "user",   line
                   )
